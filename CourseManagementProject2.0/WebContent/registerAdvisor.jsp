...
<title>RegisterAdvisor.jsp</title>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        Please input all of the information correctly into the form. 
         If you would like to see a list of all available majors. Please click the "Show All Majors" Button.
      </div>
...
<div class="padding-form">
	<form name="register" id="register" action="updateAdvisor.jsp" method="post">
		...
		<div class="form-group">
			<label for="dept">Department</label> <input name="dept" type="text"
				class="form-control" id="dept" placeholder="Department">
		</div>
	...
	<script type="text/javascript" src="regAdvisorScript.js"></script>
