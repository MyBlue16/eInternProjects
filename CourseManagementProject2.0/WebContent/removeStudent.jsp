    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        Please input all of the information correctly into the form. 
         If you would like to see a list of all students. Please click the "Show All Students" Button.
      </div>
...
<div class="padding-form">
	<form name="remove" id="remove" action="removeStud.jsp" method="post">
		<div class="form-group">
			<label for="studID">StudentID:</label> <input name="id" type="number"
	...
	<script type="text/javascript" src="removeStudScript.js"></script> 
