...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Please input all of the information correctly into the form. 
         If you would like to see a list of all administrators. Please click the "Show All Administrators" Button.
      </div>
	...
	<!-- Registration Form -->
	<h1>Remove Administrator Form</h1>
<div class="padding-form">
	<form name="remove" id="remove" action="removeAdministrator.jsp" method="post">
		<div class="form-group">
			<label for="adminID">Administrator ID:</label> <input name="id" type="number"
				class="form-control" id="id" placeholder="Administrator ID">
		</div>
	...
	<div class="button-pad">
		<button id="displayAdmins" type="button"
			class="btn btn-primary btn-lg btn-block">Show All Administrators</button>
	</div>

	<p class="para" id="message"></p>


	 <script type="text/javascript" src="removeAdminScript.js"></script> 
