  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Please input all of the information correctly into the form. If you need to display a list of all the departments click the 
...
<div class="padding-form">
	<form name="register" id="registerCourse" action="updateCourses.jsp" method="post">
		<div class="form-group">
			<label for="name">Course Name</label> <input name="name" type="text"
				class="form-control" id="name" placeholder="Degree Name"/>
		</div>
		<div class="form-group">
			<label for="department">Course Department</label> <input name="department" type="text" 
				class="form-control" id="department" placeholder="Department"/>
		</div>
		<div class="form-group">
			<label for="courseID">Course ID</label> <input name="id" type="text" 
				class="form-control" id="id" placeholder="CRN" />
		</div>
		<div class="form-group">
			<label for="location">Course Location</label> <input name="location" type="text" 
				class="form-control" id="location" placeholder="Location" />
		</div>
		<div class="form-group">
			<label for="semester">Semester Offered </label><br/> 
			<input name="semester" type="radio" id="semester"/ value="Fall"/> Fall <br/>
				<input name="semester" type="radio" id="semester" value="Spring" /> Spring <br/>
				<input name="semester" type="radio" id="semester" value="Summer" /> Summer
		</div>
		<div class="form-group">
			<label for="numClasses">Class Capacity</label> <input name="size" type="number" minValue="0"
				class="form-control" id="size" placeholder="Class Size">
		</div>
		<div class="form-group">
			<label for="startTime">Start Time</label> <input name="start" type="time" 
				class="form-control" id="start">
		</div>
		<div class="form-group">
			<label for="endTime">End Time</label> <input name="end" type="time" 
				class="form-control" id="end">
		</div>
	
	
		<button type="submit" class="btn btn-default btn-primary btn-lg">Submit Course</button>
	</form>
	</div>
	<!-- End Course Form -->
	...
	<div class="button-pad">
		<button id="displayMajors" type="button"
			class="btn btn-primary btn-lg btn-block">See All Departments</button>
	</div>
