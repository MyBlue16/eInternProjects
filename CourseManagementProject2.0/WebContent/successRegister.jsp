...
<title>successRegistration.jsp</title>
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="AdminDirectory.jsp">Admin Directory <span class="glyphicon glyphicon-user" data-toggle="popover" data-placement="bottom" title="Help" 
			data-content="I'll always be here when you need me!" aria-hidden="true">
			</span>		
			</a>
		</div>
		...
		<div class="collapse navbar-collapse"
			...
			<!-- Administrator options -->
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="addMajorOrCourses.jsp">Add Major/Course</a></li>
						<li><a href="removeMajorOrCourse.jsp">Remove Major/Course</a></li>
					</ul></li>
			</ul>
			</ul>
		</div>
