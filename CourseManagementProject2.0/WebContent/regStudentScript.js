...
function validateForm() {
	...
	var major = document.forms["register"]["major"].value;
	var classification = document.forms["register"]["classification"].value;
	...
	if (checkCharacters(classification) == false) {
		return false;
	}
