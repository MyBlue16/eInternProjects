    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        Please input all of the information correctly into the form. 
         If you would like to see a list of all courses. Please click the "Show All Courses" Button.
      </div>
...
<div class="padding-form">
	<form name="remove" id="remove" action="removeCourse.jsp" method="post">
		<div class="form-group">
			<label for="courseID">Course ID:</label> <input name="id" type="number"
				class="form-control" id="id" placeholder="Course ID">
		</div>
	...
	<script type="text/javascript" src="removeCourseScript.js"></script>
