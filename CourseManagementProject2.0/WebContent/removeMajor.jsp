...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Please input all of the information correctly into the form. 
         If you would like to see a list of all Majors. Please click the "Show All Majors" Button.
      </div>
	...
	<!-- Registration Form -->
	<h1>Remove Major Form</h1>
<div class="padding-form">
	<form name="remove" id="remove" action="removeMaj.jsp" method="post">
		<div class="form-group">
			<label for="majorName">Major Name:</label> <input name="name" type="text"
				class="form-control" id="name" placeholder="Major Name">
		</div>
	...
	<div class="button-pad">
		<button id="displayMajors" type="button"
			class="btn btn-primary btn-lg btn-block">Show All Majors</button>
	</div>

	<p class="para" id="message"></p>


	<script type="text/javascript" src="removeMajorScript.js"></script>
